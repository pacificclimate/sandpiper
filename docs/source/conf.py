...
# -*- coding: utf-8 -*-
#
# sandpiper documentation build configuration file, created by
...
# Add sandpiper to sys.path to avoid having to full
# install sandpiper for autodoc.
# Full install of sandpiper will burst memory limit on ReadTheDocs.
...
htmlhelp_basename = "sandpiperdoc"
